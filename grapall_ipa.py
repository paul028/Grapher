...
df = pd.read_csv('pb_ring.csv',names=headers)
print (df)
...
plt.legend([r'$\omega=0$',r'$\omega=1000$',r'$\omega=2000$',r'$\omega=3000$',r'$\omega=4000$',r'$\omega=5000$',r'$\omega=6000$',r'$\omega=7000$',r'$\omega=8000$',r'$\omega=9000$',r'$\omega=10000$'],loc=2)
plt.title(r' $I_{p,a}$ vs $\nu $ at $c=2$M ')
plt.ylabel(r'$I_{p,a}$(A)')
plt.xlabel(r'$\nu $')

plt.savefig('all_ipa.png', dpi=600)
...
plt.legend([r'$\omega=0$',r'$\omega=1000$',r'$\omega=2000$',r'$\omega=3000$',r'$\omega=4000$',r'$\omega=5000$',r'$\omega=6000$',r'$\omega=7000$',r'$\omega=8000$',r'$\omega=9000$',r'$\omega=10000$'],loc=2)
plt.title(r' $I_{p,a}$ vs $\sqrt{\nu} $ at $c=2$M ')
plt.ylabel(r'$I_{p,a}$(A)')
plt.xlabel(r'$\sqrt{\nu} $')

plt.savefig('all_ipa-sqrt.png', dpi=600)
